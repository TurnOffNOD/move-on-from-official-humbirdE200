...
//  begin
//    counter = (!ck_rst) ? 0 : ((counter +1) % 122);
//    CLK32768KHZ = (!ck_rst) ? 0 :
//                  ((counter ==0) ? ~CLK32768KHZ : CLK32768KHZ);
//  end
  
  reg [15 : 0] clk_32768_mon2LED_counter;
  always @(posedge CLK32768KHZ or negedge ck_rst)
  begin
    clk_32768_mon2LED_counter = (!ck_rst) ? 0 : ((clk_32768_mon2LED_counter +1) % (32768/2));
    LED_mon_clk32768 = (!ck_rst) ? 1 :
                  ((clk_32768_mon2LED_counter ==0) ? ~LED_mon_clk32768 : LED_mon_clk32768);
  end

  reg [26 : 0] board_clkin_mon2LED_counter;
  always @(posedge clk_16M or negedge ck_rst)
  begin
    board_clkin_mon2LED_counter = (!ck_rst) ? 0 : ((board_clkin_mon2LED_counter + 1) % (16000000/2));
